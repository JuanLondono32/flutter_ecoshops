...
class OfertaMateriaCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
                        ...
                        Column(children:[
                          ...
                          SizedBox(height: 8,),
                          Text(info['descripcion'].padLeft(6,'0'), style: TextStyle(color:Colors.black),),
                        ]
                        ),
                        ...
                        Row(children: [
                          Icon(Icons.email_outlined,color: Color(0xFF597C2B),),
                          SizedBox(width: 10,),
                          Text(info['email'],style: TextStyle(fontSize: 11),)
                        ],),
